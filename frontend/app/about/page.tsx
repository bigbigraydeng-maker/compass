...
const COFOUNDERS = [
  {
    ...
    bio: '投资人与创业者，拥有超过14年新西兰和澳大利亚的专业经验，在住宅房产市场和商业销售领域具有深厚专业知识。活跃于美股、量化交易系统和早期投资领域，并将重心拓展至科技驱动的商业模式与AI应用，以纪律严明、基于概率的方式进行决策。',
  ...
  },
  {
    ...
    bio: '跨境创业者与AI策略师，Compass AI、MoveHub和WorkVisas.work的创始人。搭建中国、澳大利亚和新西兰市场之间的桥梁，发掘贸易、投资与合作机会。从机器学习模型到自然语言处理，打造智能系统以提升决策效率并自动化复杂工作流程。',
