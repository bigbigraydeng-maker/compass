...
def generate_sql():
    ...
    sql_path = 'import_listings_full.sql'
    ...
    with open(sql_path, 'w', encoding='utf-8') as f:
        ...
        for i, row in enumerate(rows):
            ...
            # 处理空字符串为 NULL
            auction_date_sql = 'NULL' if not auction_date else f"'{auction_date}'"
